...
use crate::key::{
    KeyError, Tpm2shAlgId, OID_ECDSA_WITH_SHA256, OID_ECDSA_WITH_SHA384, OID_ECDSA_WITH_SHA512,
    OID_RSA_ENCRYPTION, OID_SHA1_WITH_RSA_ENCRYPTION, OID_SHA256_WITH_RSA_ENCRYPTION,
...
pub use tpm2_protocol::data::TpmtPublic;
...
fn get_signature_alg(oid: &ObjectIdentifier) -> Result<TpmAlgId, KeyError> {
...
pub fn get_algorithm(cert_der: &[u8]) -> Result<String, KeyError> {
    ...
    let sig_alg = get_signature_alg(&tbs.signature.algorithm)?;
